...
#pragma mark - Get user from parse object
- (NSArray *)getUserFromParseObject:(PFObject *)parseObject {
    PFUser *user = parseObject[@"byUser"];
    QBUUser *opponent = [QBUUser user];
    opponent.login = user.username;
    opponent.ID = 8334346;
    QBUUser *item = [QBUUser user];
    item.login = @"item2131";
    item.ID = 8695899;
    [[ServicesManager instance].usersService.usersMemoryStorage addUsers:@[opponent, item]];
